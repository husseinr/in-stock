 ...
 function AddInventory() {
    ...
    return (
        ...
        <main>
            ...
            <h1 className="add-inventory__header"> <img src= {arrowLogo} alt="return-logo"/> Add New Inventory Item</h1>
                ...
                <div className="add-inventory__details">
                    ...
                    <div className="add-inventory__details-select">
                        ...
                        <select className="add-inventory__details-select-field" type="select" placeholder="Please select"/>
                    </div>
                ...
                <div className="add-inventory__availability">
                    <h2 className="add-inventory__availability-header"><img></img>Item Availability</h2>
